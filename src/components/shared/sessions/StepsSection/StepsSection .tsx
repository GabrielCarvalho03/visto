...
export const StepsSection = () => {
  ...
  return (
    <section className="w-full flex flex-col  gap-10 2xl:max-w-7xl mx-auto my-32 pl-10  2xl:p-0 ">
      <div className="w-full flex justify- items-center pr-10">
        <div className=" w-2/3 flex flex-col">
          ...
          <h1 className="text-6xl font-medium tracking-[-1.5px]">
      ...
      <div className="w-full flex justify-between items-center gap-10 mt-14">
